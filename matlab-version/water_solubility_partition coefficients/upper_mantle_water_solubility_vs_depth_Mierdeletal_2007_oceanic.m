...
saveas(gcf, 'water_solubility_ocean.png');
print(gcf, 'water_solubility_ocean', '-dpng', '-r300'); % Save at 300 dpi
hold off;
...
% Save the figure in high-quality format (300 dpi)
saveas(gcf, 'water_partition_ocean.png');
print(gcf, 'water_partition_ocean', '-dpng', '-r300'); % Save at 300 dpi
hold off;
