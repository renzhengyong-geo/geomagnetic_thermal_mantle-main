function [sigma_upper, sigma_lower] = Karato_mtz_lower_electrical_conductivity(T, P, ring_f, g_f, C_water, water_partition_coefficients)
...
% inferred from electrical conductivity of wadsleyite and ringwoodite. Nature 451:326–29
    ...
    sigma_ring = Karato_ringwoodite_conductivity(T, water_in_ringwoodite, P); 
