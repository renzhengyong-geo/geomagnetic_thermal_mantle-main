function [sigma_upper, sigma_lower]=karato_upper_mantle_electrical_conductivity(T, P, o_f, opx_f, cpx_f, g_f, C_water,  water_partition_coefficients)
...
sigma_o   = Karato_olivine_conductivity(T, C_water*water_partition_coefficients(1), P);
sigma_opx = Karato_orthopyroxene_conductivity(T, C_water*water_partition_coefficients(2), P);
sigma_cpx = Karato_clinopyroxene_conductivity(T, C_water*water_partition_coefficients(3), P);
sigma_g   = Karato_garnet_conductivity(T, C_water*water_partition_coefficients(4), P);
