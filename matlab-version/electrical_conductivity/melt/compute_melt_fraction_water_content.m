function [F2_HS, F2_parallel, w_HS, w_parallel] = compute_melt_fraction_water_content(sigma_bulk, C0, T, D, sigma_solid)
    % Ni, H., Keppler, H., & Behrens, H. (2011). Electrical conductivity of
    % hydrous basaltic melts: Implications for partial melting in the upper
    % mantle. Contributions to Mineralogy and Petrology, 162(3), 637–650.
    % https://doi.org/10.1007/s00410-011-0617-4
