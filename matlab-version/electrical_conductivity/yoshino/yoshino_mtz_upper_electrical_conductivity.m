function [sigma_upper, sigma_lower] = yoshino_mtz_upper_electrical_conductivity(T, P, wad_f, g_f, C_water, water_partition_coefficients)
...
% Annual Review of Earth and Planetary Sciences, 41, 605-628.
    ...
    sigma_wad = Yoshino_wadsleyite_conductivity(T, water_in_wadsleyite, P, Xfe_in_wadsleyite); 
