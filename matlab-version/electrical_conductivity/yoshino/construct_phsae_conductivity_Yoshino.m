...
for i = 1:length(depth)
    for j = 1:length(Cw)
        ...
        sigma = [sigma_garnet,sigma_orthopyroxene,sigma_Perovskite,sigma_C2c,sigma_cpx,...
            sigma_ringwoodite,sigma_wadsleyite,sigma_olivine,sigma_ferropericlase,sigma_ca_pv,...
            sigma_akimotoite];
...
save('./file/water_content_SH_Yoshino_upper_new.txt','sigma_upper','-ascii')
save('./file/water_content_SH_Yoshino_lower_new.txt','sigma_lower','-ascii')
% save('./file/Yoshino_upper_1.txt','sigma_upper','-ascii')
% save('./file/Yoshino_lower_1.txt','sigma_lower','-ascii')
