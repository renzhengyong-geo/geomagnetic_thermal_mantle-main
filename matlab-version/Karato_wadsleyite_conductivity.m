% ------------------------------------------------------------------------
% FUNCTION: Karato_Wadsleyite_conductivity
% ------------------------------------------------------------------------
% DESCRIPTION:
% Compute the conductivity of Wadsleyite using Karato's group high temperature
...
function sigma = Karato_wadsleyite_conductivity(T, Cw, P)
    % Constants
    ...
    E2 = 88000;      % Activation energy for proton conduction, J/mol
