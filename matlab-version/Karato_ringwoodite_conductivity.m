% ------------------------------------------------------------------------
% FUNCTION: Karato_Ringwoodite_conductivity
% ------------------------------------------------------------------------
% DESCRIPTION:
% Compute the conductivity of Ringwoodite using Karato's group high temperature
...
%   Cw  - Water content (dimensionless) in wt%.
...
function sigma = Karato_ringwoodite_conductivity(T, Cw, P)
    % Constants
    ...
    E2 = 104000;     % Activation energy for proton conduction, J/mol
