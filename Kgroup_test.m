...
% To replot the figure 3 (Generate the Ito_Katsura_geothermail_EPS_1989)
...
% To test figure 3
% 1. we use the pyrolite mantle model along the path of Ito_Katsura_geothermal_1989_pressure_temperature
% The mantle model is defiend in file "karato2011pyrolite_2.tab"
