...
double Yoshino_clinopyroxene_conductivity(double temperature, double water_content, double pressure) {
    // Constants
    ...
    const double sigma_i = 1778;              // Intrinsic conductivity in S/m
    const double Hi = 1.87;                   // Activation enthalpy for intrinsic conduction in eV
...
int main() {
    ...
    try {
        double conductivity = Yoshino_clinopyroxene_conductivity(temperature, water_content, pressure);
