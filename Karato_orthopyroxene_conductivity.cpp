...
// Function to compute the conductivity of Orthopyroxene using Karato's model
double Karato_orthopyroxene_conductivity(double T, double Cw, double P) {
    // Constants for the equation
    const double A1 = pow(10, 2.7);   // Pre-exponential factor for polaron conduction, S/m
    const double A2 = pow(10, 2.6);   // Pre-exponential factor for proton conduction, S/m
...
int main() {
    ...
    double sigma = Karato_orthopyroxene_conductivity(T, Cw, P);
